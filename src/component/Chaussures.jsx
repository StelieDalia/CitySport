...
return (
  <div className='chaussuresBox' id='shoes'>
      ...
      <div className='Selects'>
        ...
        <Button size="small" onClick={filteredBrand} sx={{color: '#009044'}} > Filtrer</Button>
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          Pointure:{chaussure.pointure} - {chaussure.couleur}
        </Typography>
        <br></br>
      ...
      <CardActions>
        <Button size="small" sx={{color: '#009044'}}> Acheter</Button>
        <Button size="small" sx={{color: '#009044'}}>Ajouter au panier</Button>
      </CardActions>
        </Card>)})}
      </div>
